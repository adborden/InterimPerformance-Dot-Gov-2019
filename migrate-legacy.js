...
function processFile(filepath) {
  ...
  const [ dummy, agency_dir ] = filepath.split('/');
  ...
  if (!$content.length) {
    console.log(`no #main-content in ${filepath}`);
    return;
  }
  ...
  stream.write(`layout: apg\n`);
  stream.write(`agency_dir: ${agency_dir}\n`);
  stream.write(`---\n`);
